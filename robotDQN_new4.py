...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 18:54:05 2019
        ...
        if self.content:
            ...
            if self.ntype == 'd1qn' or self.ntype == 'd4qn':
                ...
                if self.logit:
                    ...
                    qvalue_batch_target = self.sess.run(self.mainQN.qvalue, feed_dict={self.mainQN.x: concatenate_x,self.mainQN.state_confidence: next_state_confidence_batch, self.mainQN.predictions: list(concatenate_predictions)})
