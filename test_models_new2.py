...
def main(in_iter):
    ...
    for CONTENT in CONTENTS:
        for CUM in CUMS:
            MODEL_VER_0 = 'model_hidden_{0}_it_{1}_budget_{2}_content_{3}_cum_{4}_logits_{5}_fcls_{6}_{7}'.format(NTYPE, NITER, BUDGET, int(CONTENT), int(CUM), int(LOGIT), int(FCLS), method)
