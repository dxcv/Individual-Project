...
path = "/data/orudovic/v_latest/records/*.csv"
...
#colnames = ['f1_test', 'f1_majority_train', 'f1_majority_test', 'count_0', 'count_1', 'conf_train','conf_test']
#colnames2 = ['f1_train', 'f1_test', 'conf_train','conf_test']

bud = '5'

output = '/data/orudovic/random/results_summary_majority_'+bud+'.csv'
